...
//TODO: Reroute this to credentials page if no credentials in database.
Router.map(function () {
    this.route('home', {
        path: '/',
        action: function () {
    ...
    this.route('/exportStudentCSV', {
        ...
        action: function () {
            ...
            Students.find().forEach(function (student) {
                ...
                csv += '\"' + standardizedPhoneFormat(student.phone) + '\"\n';
            });
    ...
    this.route('/say/:phone', {
        ...
        action: function () {
            ...
            var consultdata = Consults.findOne({phone: standardizedPhoneFormat(phone), activate: true});
    ...
    this.route('/sendConfirmation', {
        ...
        action: function () {
            ...
            var consult_id = Consults.findOne({phone: standardizedPhoneFormat(phone), activate: true})._id;

            Responses.insert({
                callSid: CallSid,
                phone: standardizedPhoneFormat(phone),
            ...
            var student = Students.findOne({phone: standardizedPhoneFormat(phone)});
            if (student) {
                Meteor.call('sendEmail',
                    student.email,
                    'TwitterConsults@gmail.com',
                    'On-Call Consult Response',
                    'You can review your consult response at ' + RecordingURLMP3);
            }
