...
TabularTables.Consults = new Tabular.Table({
    ...
    columns: [
        ...
        {
            data: "_id", title: "Consult",
            render: function (val) {
                // return "<a href = " + Meteor.absoluteUrl() + "oncall/" + val + " target='_blank' >Consult</a>";
                var consultpage = ConsultPages.findOne({consult_id: val}).consultURL;
                return "<a href = " + consultpage + " target='_blank' >Consult</a>";
            }
        },
